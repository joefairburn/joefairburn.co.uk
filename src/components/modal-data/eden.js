...
function EdenText(props) {
  ...
  return (
    <>
      ...
      This is a promtional site created in 2018 as part of a web design module I
      was taking. The brief was to create a static brochure style site, which
      functioned on both a 1920 x 1080, and 800 x 1280 display, using only HTML,
      CSS. I decided to create a new website for Eden. His{" "}
      <a
      ...
      navigate and wasn't visually appealing. I took inspiration from his music
      and brand, to create something that maintained his current style, while
